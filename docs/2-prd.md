...
| FR-05-9 | 공지사항 작성·채팅 상단 고정 표시 | Must | BR-10 |
...
| S-07 | 프로젝트 목록 | /teams/[teamId]/projects | 팀원 | 팀 프로젝트 목록, 프로젝트 생성 버튼 |
| S-08 | 프로젝트 간트차트 | /teams/[teamId]/projects/[projectId] | 팀원 | 간트차트 뷰, 프로젝트 일정·세부 일정 CRUD |
| S-09 | 공지사항 | /teams/[teamId]/notices | 팀원 | 공지사항 목록, 작성·삭제 |
